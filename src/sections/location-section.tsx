...
export function LocationSection({language}: LocationSectionProps) {
  ...
  return (
    <section className="bg-[#F1ECE4]">
      <div className="mx-auto grid max-w-7xl gap-8 px-4 py-14 sm:px-6 sm:py-16 lg:grid-cols-[0.95fr_1.05fr] lg:gap-12 lg:px-8 lg:py-20">
        <div className="flex flex-col justify-center">
          ...
          <div className="mt-6 grid gap-3 sm:grid-cols-2">
            {content.bullets.map((bullet) => (
              <div
                key={bullet}
                className="flex items-start gap-3 rounded-[18px] border border-[#E7DED2] bg-white/80 p-4 shadow-[0_10px_28px_rgba(31,31,31,0.05)]"
              >
        ...
        <div className="relative overflow-hidden rounded-[28px] border border-[#E2D7C8] bg-[#1F1F1F] p-6 text-white shadow-[0_24px_60px_rgba(31,31,31,0.14)] sm:p-8">
          ...
          <div className="relative min-h-[280px] rounded-[22px] border border-white/15 bg-white/8 p-5 sm:min-h-[340px] sm:p-6">
